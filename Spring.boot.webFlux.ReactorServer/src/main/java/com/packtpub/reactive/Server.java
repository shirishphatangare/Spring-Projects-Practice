...
public class Server { // Change JRE System library to JavaSE 1.8

	public static final String HOST = "localhost";
	public static final int PORT = 8081;

// With below main method Server class can run as a standalone Java application or
// standalone Spring boot application. Code below to start server moved to TicketManagementApplication class
