...
public class MethodSecurityTest	 {
	...
	@Test(expected = AuthenticationCredentialsNotFoundException.class) // Test pass since no credentials are passed and AuthenticationCredentialsNotFoundException is expected
	...
	public void withMockUserOnlyRoleTest() { // pass
		homeController.findByUserName("test");
	}
	
	@Test
	@WithMockUser(username = "admin",authorities={"ROLE_ADMIN"}) // pass
