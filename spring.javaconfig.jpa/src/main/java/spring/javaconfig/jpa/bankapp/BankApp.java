...
import spring.javaconfig.jpa.bankapp.service.BankAccountService;
import spring.javaconfig.jpa.bankapp.service.FixedDepositService;
...
public class BankApp {
	...
	public static void main(String args[]) throws Exception {
		...
		context.scan("spring.javaconfig.jpa.bankapp"); // Just "spring.javaconfig" also can be used here
		context.refresh();
